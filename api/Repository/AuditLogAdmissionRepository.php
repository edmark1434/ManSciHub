...
class AuditLogAdmissionRepository {
    ...
    public function getAllAuditLogAdmission(): array {
        $query = "
            SELECT a.chg_id, a.adms_id as track_id, a.chg_old_val, a.chg_new_val, a.chg_datetime, ad.admin_username, r.adms_date , s.stud_fname, s.stud_mname, s.stud_lname, s.stud_suffix 
